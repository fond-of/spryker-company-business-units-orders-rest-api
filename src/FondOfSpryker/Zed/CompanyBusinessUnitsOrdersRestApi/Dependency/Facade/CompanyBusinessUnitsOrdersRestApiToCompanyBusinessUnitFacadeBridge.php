...
class CompanyBusinessUnitsOrdersRestApiToCompanyBusinessUnitFacadeBridge implements CompanyBusinessUnitsOrdersRestApiToCompanyBusinessUnitFacadeInterface
{
    /**
    ...
    public function findCompanyBusinessUnitByUuid(
        ...
        return $this->companyBusinessUnitFacade->findCompanyBusinessUnitByUuid($companyBusinessUnitTransfer);
    }
}
